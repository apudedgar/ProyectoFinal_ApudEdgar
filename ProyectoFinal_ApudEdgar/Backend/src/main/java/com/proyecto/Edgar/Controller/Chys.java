...
public class Chys {
    ...
    public ResponseEntity<?> create(@RequestBody dtoHys dtohys) {
        ...
        if (shys.existsByNombre(dtohys.getNombre())) {
            return new ResponseEntity(new Mensaje("Esa skill ya esta cargada"), HttpStatus.BAD_REQUEST);
        }
