...
import com.proyecto.Edgar.Dto.dtoExperiencia;
import com.proyecto.Edgar.Entity.Experiencia;
import com.proyecto.Edgar.Security.Controller.Mensaje;
import com.proyecto.Edgar.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp) {
        ...
        if (sExperiencia.existsByNombreE(dtoexp.getNombreE())) {
            return new ResponseEntity(new Mensaje("Esa experiencia ya esta cargada"), HttpStatus.BAD_REQUEST);
        }
